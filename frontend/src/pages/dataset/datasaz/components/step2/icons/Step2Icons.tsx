...
export const TrashIcon: React.FC<IconProps> = ({ width = 14, height = 14, ...props }) => (
...
export const QuestionIcon: React.FC<IconProps> = ({ width = 14, height = 14, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width={width} height={height} {...props}>
...
export const ExpandIcon: React.FC<IconProps> = ({ width = 14, height = 14, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width} height={height} {...props}>
...
export const AddIcon: React.FC<IconProps> = ({ width = 14, height = 14, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" width={width} height={height} {...props}>
...
export const SearchIcon: React.FC<IconProps> = ({ width = 14, height = 14, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width} height={height} {...props}>
