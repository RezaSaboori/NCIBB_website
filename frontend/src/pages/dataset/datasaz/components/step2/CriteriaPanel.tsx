...
export const CriteriaPanel: React.FC<CriteriaPanelProps> = ({ type }) => {
  ...
  return (
    <div className="glass dz-glass-container dz-glass-container--lg s2-criteria-panel">
      {/* Header */}
        ...
        <div className="s2-panel-header__search">
          <div className="s2-panel-header__search-box">
            <input
              ...
              disabled
            />
            <button className="glass s2-icon-btn" aria-label="Search">
          ...
          <button className="glass s2-icon-btn" aria-label="Help">
            <svg  width="14"   height="14"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">
