...
export const CONFIG = {
  ...
  heart: {
    // Mouse interaction
    heartGrow: 1.5,              // Enlargement factor when mouse hovers
    mouseRadius: 0.8,            // Radius of mouse interaction area
    ...
    heartDensity: parseFloat(localStorage.getItem('heartDensity')) || 0.01, // Particle density (requires reload)
    particleCount: parseInt(localStorage.getItem('particleCount')) || 13000, // Particle count override (0 = auto, requires reload)
    // Camera
    ...
    maxNeighbors: 10,            // Number of nearest neighbors to connect (1-12)
  ...
  ambientType1: {
    ...
    areaMultiplier: 5,         // Multiplier for sphere radius relative to heart
...
export function getFlatConfig() {
  return {
    ...
    heartColor: CONFIG.heart.heartColor ? hexToRgb(CONFIG.heart.heartColor) : null,
    ...
    connectionOpacity: CONFIG.heart.connectionOpacity,
    connectionColor: hexToRgb(CONFIG.heart.connectionColor),
    ...
    glowColor: hexToRgb(CONFIG.glow.color),
    ...
    ambientType1Color: hexToRgb(CONFIG.ambientType1.color),
    ...
    ambientType2Color: hexToRgb(CONFIG.ambientType2.color),
